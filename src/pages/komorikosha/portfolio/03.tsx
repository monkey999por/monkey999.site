              ...
              <section className={styles.articleDetailBody}>
                <section>
                  ...
                  <p>
                    ...
                    decided to start by making a picture book. The password is
                    to become a grasshopper! Well, anyway, please read the
                    picture book (^ ^)
                  </p>
                  <table>
                ...
                <section>
                  ...
                  <p>
                    In producing the picture book, Hiroshima tried JavaScript
                    for the first time. I explain how to make it on my blog, so
                    if you are interested, please see this article .
                  </p>
