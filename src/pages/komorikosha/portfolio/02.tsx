            ...
            <article className={styles.articleDetail}>
              ...
              <section className={styles.articleDetailBody}>
                <section>
                  ...
                  <p>
                    ...
                    WordPress theme customization written by Comomo and
                    Hiromasya.
                  </p>
                  <p>
              ...
              <footer className={styles.articleDetailFoot}>
                ...
                <aside className={styles.creditUnit}>
                  ...
                  <p>
                    A crepe shop that also appears as a sample site for
                    WordPress design workbooks. The crepe dough with okara is
